                ...
                <div className='row'>
                    <div className='card p-1 mb-3'>
                        ...
                        <div className='projectList-btn d-flex py-1 px-3 justify-content-end gap-2'>
                            <button className='btn btn-danger btn-sm' onClick={ () => remove(id) }> Delete <i className="bi bi-trash3-fill"></i></button>
                            <Link className='btn btn-primary btn-sm' to={`/editTask/${data}`} style={{ textDecoration: 'none' }} >Edit <i className="bi bi-pencil-fill"></i></Link>
                        </div>   
                    </div>
                </div>   
            </div>
